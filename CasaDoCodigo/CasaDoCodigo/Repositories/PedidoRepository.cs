...
namespace CasaDoCodigo.Repositories
{
    public interface IPedidoRepository
    {
        ...
        Pedido GetPedido();
        UpdateQuantidadeRespoonse UpdateQuantidade(ItemPedido itemPedido);
    ...
    public class PedidoRepository : BaseRepository<Pedido> , IPedidoRepository
    {
        ...
        public UpdateQuantidadeRespoonse UpdateQuantidade(ItemPedido itemPedido)
        {
            ...
            if (itemPedidoDB != null)
            {
                ...
                return new UpdateQuantidadeRespoonse(itemPedidoDB, carrinhoViewModel);
            }
